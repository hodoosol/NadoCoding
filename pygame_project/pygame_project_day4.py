...
# 게임 종료 메세지
# Timeout(시간 초과 실패), Mission Complete(성공), Game Over(캐릭터 공에 맞음)
...
while running:
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx < 3 :
                    ...
                    balls.append({
                        ...
                        "to_x": -3,  # 공의 x축 이동 방향, -3이면 왼쪽으로
                        "to_y": -6,  # 공의 y축 이동 방향
                        "init_speed_y": ball_speed_y[ball_img_idx + 1]})  # y의 최초 속도
    ...
    timer = game_font.render("Time : {}"
                             .format(int(total_time - elapsed_time)),
                             True, (255, 255, 255))
